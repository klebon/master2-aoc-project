...
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/active_object_simple.png "Active Object simple")
...
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/active_object_proxy.png "Active Object et proxy")
...
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/active_object_proxy_strategy.png "Active Object, proxy et strategy")
...
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/active_object_proxy_strategy_observer.png "Active Object, proxy, strategy et observer")
...
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/active_object_proxy_strategy_observer_memento.png "Active Object, proxy, strategy, observer et memento")
...
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/active_object_proxy_strategy_observer_memento_all.png "Tout")
...
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/window.png "Fenêtre démarrage")
...
Atomique :
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/atomic.png "Diffusion atomique en image")
Nous voyons bien sur l'image que l'ensemble des fenêtres des afficheurs est synchronisé avec la fenêtre du capteur.

Séquentiel :
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/sequential.png "Diffusion séquentielle en image")
...
Par époque :
[alt text](https://github.com/Nhitro/master2-aoc-project/blob/master/image/version.png "Diffusion par époque en image")
